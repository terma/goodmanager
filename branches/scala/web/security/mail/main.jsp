...
<html>
    ...
    <body>
        <p>
            ...
            <a href="<login:link value="/security/mail/refreshresult.jsp?now=true"/>">проверить</a>,
            <a href="<login:link value="/security/mail/send.jsp"/>">написать</a>
            <% if (user.getGroup().id == 2) { %>
                <a href="<login:link value="/security/mail/server/list.jsp"/>">серверы</a>,
                <a href="<login:link value="/security/mail/refreshresult.jsp"/>">лог</a>
            <% } %>
        </p>
                            ...
                            <table border="0" cellpadding="0" cellspacing="10">
                                ...
                                <% for (final EntityMail mail : mails) { %>
                                    <tr>
                                        ...
                                        <td><a href="<login:link value="<%= "/security/mail/detail.jsp?mailId=" + mail.mailId %>"/>"><%= trimTo(mail.theme, 70) %></a></td>
                                    </tr>
                                <% } %>
                            </table>
                        </form>
