...
<html>
    ...
    <body>
        К <a href="<login:link value="/security/tiding/main.jsp"/>">новости</a>,
        добавление новости в категорию
        <a href="<login:link value="<%= "/security/tiding/main.jsp?tidingCategoryId=" + tidingCategory.id %>"/>"><%= tidingCategory.name %></a>
        <%
