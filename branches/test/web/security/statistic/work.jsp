                ...
                <% if (!createFirms.isEmpty()) { %>
                    ...
                    <ul>
                        <% for (final EntityFirm firm : createFirms) { %>
                            <li><a href="<login:link value="<%= "/security/detail.jsp?firmId=" + firm.getId() %>"/>"><%= firm.getName() %></a></li>
                        <% } %>
                    </ul>
                <% } %>
                ...
                <% if (!updateFirms.isEmpty()) { %>
                    ...
                    <ul>
                        <% for (final EntityFirmHistory firmHistory : updateFirms) { %>
                            <li><a href="<login:link value="<%= "/security/detail.jsp?firmId=" + firmHistory.id.firm.getId() %>"/>"><%= firmHistory.id.firm.getName() %></a></li>
                        <% } %>
                    </ul>
                <% } %>
                        ...
                        <% for (final EntityPipol pipol : createPipols) { %>
                            <li>
                                ...
                                <% } else { %>
                                    <%= pipol.getFio() %>
                                <% } %>
                                из <a href="<login:link value="<%= "/security/detail.jsp?firmId=" + pipol.getFirm().getId() %>"/>"><%= pipol.getFirm().getName() %></a>
                            </li>
                        <% } %>
                    </ul>
                <% } %>
                    ...
                    <ul>
                        <% for (final EntityPipolHistory pipolHistory : updatePipols) { %>
                            <li>
                                ...
                                <% } %>
                                из <a href="<login:link value="<%= "/security/detail.jsp?firmId=" + pipolHistory.id.pipol.getFirm().getId() %>"/>"><%= pipolHistory.id.pipol.getFirm().getName() %></a>
                            </li>
                        <% } %>
                    </ul>
                <% } %>
                    ...
                    <ul>
                        <% for (final EntityContractVersion contractVersion : createContractVersions) { %>
                            <li>
                                ...
                                <a href="<login:link value="<%= "/security/contract/detail.jsp?contractId=" + contractVersion.contract.id %>"/>"><%= contractVersion.contract.name %></a>
                            </li>
                        <% } %>
                    </ul>
                <% } %>
