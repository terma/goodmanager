...
<html>
    ...
    <body>
        ...
        <table border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="top">
                    Добавить <a href="<login:link value="/security/tiding/categoryadd.jsp"/>">категорию</a>
                    <ul>
                        <% for (final EntityTidingCategory category : tidingCategorys) { %>
                            <li>
                                <a href="<login:link value="<%= "/security/tiding/main.jsp?tidingCategoryId=" + category.id %>"/>"><%= category.name %></a>
                            </li>
                        <% } %>
                    </ul>
                </td>
                <td valign="top" style="padding-left: 20px">
                    ...
                    <% } else { %>
                        <p>
                            ...
                            <a href="<login:link value="<%= "/security/tiding/tidingadd.jsp?tidingcategoryid=" + selectTidingCategory.id %>"/>">новость</a>
                        </p>
                        <% if (tidings.isEmpty()) { %>
                            В этой категории к сожалению нет новостей. Но можно
                            <a href="<login:link value="<%= "/security/tiding/tidingadd.jsp?tidingCategoryId=" + selectTidingCategory.id %>"/>">добавить</a>
                        <% } else { %>
