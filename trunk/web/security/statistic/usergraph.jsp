...
<html>
    ...
    <body>
        <p>
            Назад к <a href="<login:link value="/security/statistic/user.jsp"/>">статистики</a>, или к
            <a href="<login:link value="/security/main.jsp"/>">разделам</a>, максимум <%= countMax %>            
        </p>
                                                        ...
                                                        <table border="0" cellpadding="0" cellspacing="0">
                                                            ...
                                                            <tr>
                                                                <td valign="bottom" <%= value == 0 ? "rowspan=\"2\"" : "" %>>
                                                                    <a target="_blank" href="<login:link value="<%= "/security/statistic/userdaygraph.jsp?start=" + statistic.start.getTime() + "&finish=" + statistic.finish.getTime() + "&userid=" + statisticUser.user.getId() %>"/>"><img src="/image/border.gif" border="0"
