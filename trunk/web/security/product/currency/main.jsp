...
<html>
    ...
    <body>
        ...
        <p>
            ...
            <a href="<login:link value="/security/product/main.jsp"/>">продуктам</a>
            <a href="<login:link value="/security/product/currency/add.jsp"/>">добавить</a> валюту
        </p>
        ...
        <% } else { %>
            <ul>
                <% for (final EntityCurrency currency : currencys) { %>
                    <li>
                        <a href="<login:link value="<%= "/security/product/currency/delete.jsp?currencyid=" + currency.id %>"/>"><img
