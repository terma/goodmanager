...
public class LogicSearch {
    ...
    public static void park(int searchId) {
        final EntitySearch search = (EntitySearch) ua.com.testes.manager.entity.EntityManager.find(EntitySearch.class, Integer.valueOf(searchId));
 ...
 * Qualified Name:     ua.com.testes.manager.logic.search.LogicSearch
