...
<html>
    ...
    <body>
        ...
        %>
        Вернуться к <a href="/security/main.jsp">главной</a>
        <% if (user.getGroup().id == 2) { %>, добавить <a href="/security/useradd.jsp">пользователя</a>
        добавить <a href="/security/groupadd.jsp">группу</a>
        <p>
            <%
