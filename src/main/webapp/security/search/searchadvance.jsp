...
<html>
    ...
    <body>
        <p>
            ...
            расширенный поиск, к
            <a href="/security/search/search.jsp">простому</a>
            поиску
        </p>
                                        ...
                                        <td width="50%" valign="top">
                                            ...
                                            <% for (final EntitySection section : sections) { %>
                                                <li>
                                                    ...
                                                    <% String link1 = "/security/list.jsp?sectionid=" + section.getId(); %>
                                                    <a href="<%= link1 %>"/>"><%= LogicStyle.getHtml(section.getStyle(), section.getName()) %></a>
                                                </li>
                                            <% } %>
                                            </ul>
                                        </td>
                        ...
                        <% if (!parkSearchs.isEmpty()) { %>
                            <p>                        
                                <% for (final EntitySearch search : parkSearchs) { %>
                                    <p>
                                        <a href="<%= "/security/search/searchadvancedeleteresult.jsp?searchId=" + search.id %>"><img src="/image/delete.gif" alt="Удалить" border="0" width="15" style="vertical-align: top;" height="15"></a>
                                        От <%= format.format(search.use) %>,
                                        <a href="<%= "/security/search/searchadvance.jsp?searchId=" + search.id %>">посмотреть</a>,
                                        <a href="<%= "/security/search/searchadvanceresult.jsp?searchId=" + search.id %>">результат</a>
                        ...
                        <p>
                            ...
                            <% for (final EntitySearch search : useSearchs) { %>
                                <p>
                                    ...
                                    <a href="<%= "/security/search/searchadvance.jsp?searchId=" + search.id %>">посмотреть</a>,
                                    <a href="<%= "/security/search/searchadvanceresult.jsp?searchId=" + search.id %>">результат</a>,
                                    <a href="<%= "/security/search/searchadvanceparkresult.jsp?searchId=" + search.id %>">сохранить</a>
                                    <% writeSearch(search, out, format); %>
                                </p>
                            <% } %>
                        </p>
