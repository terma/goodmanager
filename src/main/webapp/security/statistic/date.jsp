...
<html>
    <head>
        <title>По дате - Статистика - Менеджер <version:number/></title>
    ...
    <body>
        <%
            ...
            final Set<PageStatisticDate.Error> errors = (Set<PageStatisticDate.Error>) request.getAttribute("errors");

            // Выбираем условия для статистики из сесии
            PageStatisticDate pageStatistic = (PageStatisticDate) session.getAttribute("pageStatisticDate");
            ...
            <tr>
                <td valign="top">
                    ...
                    <p>
                        ...
                        <% if (errors != null && errors.contains(PageStatisticDate.Error.INCORRECT_DATE)) { %>
                            <p><b>Пожайлусто введите верную начальную и конечную дату!</b></p>
                        <% } %>
                        <% if (errors != null && errors.contains(PageStatisticDate.Error.START_AFTER_FINISH_DATE)) { %>
                    ...
                    <p>
                        Шаг графика
                        <select size="1" name="statisticstep" style="vertical-align: middle;">
                            <option value="1" <%= pageStatistic.step == 1 ? "selected" : "" %>>День</option>
                            <option value="10" <%= pageStatistic.step == 10 ? "selected" : "" %>>10 Деней</option>
                            <option value="15" <%= pageStatistic.step == 15 ? "selected" : "" %>>15 Деней</option>
                            <option value="30" <%= pageStatistic.step == 30 ? "selected" : "" %>>Месяц</option>
                            <option value="90" <%= pageStatistic.step == 90 ? "selected" : "" %>>Квартал</option>
                            <option value="365" <%= pageStatistic.step == 365 ? "selected" : "" %>>Год</option>
                        </select>
                    </p>
                </td>
                <td valign="top">
